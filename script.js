...
async function loadAllPortfolioData() {
    ...
    // Define base path for images - adjusted for correct folder structure
    const basePath = '../images/portfolio';
    
    // Test image paths - adjusted for correct folder structure
    const testPaths = [
        '../images/portfolio/exterior/exterior-1.jpg',
        '../images/Dilawar CV.png',
        '../images/placeholder.jpg'
    ];
    
    testPaths.forEach(checkImagePath);
